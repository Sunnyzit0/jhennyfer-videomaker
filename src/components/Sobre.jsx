    ...
    <section className="intro-band section-padding" id="sobre">
      ...
      <div className="about-grid">
        ...
        <div className="about-copy">
          ...
          <p>Eu acredito que os melhores registros acontecem quando a gente se sente à vontade para ser quem é. Meu trabalho é criar esse espaço: observar com carinho, dirigir quando precisa e deixar a verdade aparecer. (descrição gerada por IA.)</p>
