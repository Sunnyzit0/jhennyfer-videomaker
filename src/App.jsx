...
function App() {
  ...
  return (
    <div className="site-shell">
      ...
      <footer className="site-footer"><a className="brand" href="#inicio"><span className="brand-mark">J</span><span>Jhennyfer</span></a><span>© {new Date().getFullYear()} · feito com intenção</span><a href="#inicio" className="back-top">voltar ao topo <ArrowUpRight size={15} /></a></footer><a className="floating-whatsapp" href={whatsappLink} target="_blank" rel="noreferrer" aria-label="Falar com Jhennyfer pelo WhatsApp"><MessageCircle size={22} /></a>
